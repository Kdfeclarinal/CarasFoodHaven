...
function addNewIngredient() {
    ...
    const lowStockThreshold = parseInt(document.getElementById("ingredient-low-stock-threshold").value);
    const mediumStockThreshold = parseInt(document.getElementById("ingredient-medium-stock-threshold").value);
    const reorderPoint = parseInt(document.getElementById("ingredient-reorder-point").value);
    ...
    const getTotalQuantity = parseInt(totalQuantity);
    ...
    addIngredientData.append('total-quantity', getTotalQuantity);
...
function addNewIngredientCategory() {
    ...
    fetch('ingredient_category_handler.php', {
        method: 'POST',
...
function deleteSelectedIngredientCategory(tableID, dataName) {
    ...
    // Check if a row is selected
    if (!selectedRow) {
        showNotification(`Select a row to delete from the table.`);the
        return;
    }
...
function addNewIngredientUnit() {
    ...
    fetch('ingredient_unit_handler.php', {
        method: 'POST',
        body: addUnitData
    })
    .then(response => {
